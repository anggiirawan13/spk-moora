        ...
        <div class="card-body">
            <form action="{{ route('mobil.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="pemilik" placeholder="Masukkan nama pemilik mobil" id="pemilik" value="{{ old('pemilik') }}"></textarea>
                </div>
                <div class="form-group">
                    <label for="alamat_pemilik">Alamat Pemilik</label>
                    <textarea class="form-control" name="alamat_pemilik" placeholder="Masukkan alamat lengkap pemilik" id="alamat_pemilik" value="{{ old('alamat_pemilik') }}"></textarea>
                </div>
                <div class="form-group">
                    <label for="deskripsi">Deskripsi Mobil</label>
                    <textarea class="form-control" name="deskripsi" placeholder="Masukkan deskripsi mobil" id="deskripsi" value="{{ old('deskripsi') }}"></textarea>
                </div>
                <div class="form-group">
