            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <img src="{{ $car1->image_path ? asset('storage/car/' . $car1->image_path) : asset('img/default-image.png') }}" class="img-fluid rounded shadow my-3" alt="{{ $car1->name }}">
                        <x-table_car :car="$car1" />
                    </div>
                    <div class="col-md-6">
                        <h4><strong>Mobil 2: {{ $car2->name }}</strong></h4>
                        <img src="{{ $car2->image_path ? asset('storage/car/' . $car2->image_path) : asset('img/default-image.png') }}" class="img-fluid rounded shadow my-3" alt="{{ $car2->name }}">
