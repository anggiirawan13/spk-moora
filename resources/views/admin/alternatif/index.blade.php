                        ...
                        <td>
                            <div>
                                <form action="{{ route('alternatif.destroy', $item->id )}}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <a href="{{ route('alternatif.edit', $item->id ) }}" class="btn bg-primary btn-sm text-white"><i class="fas fa-edit"></i></a>
                                    <button type="submit" class="btn bg-danger btn-sm text-white" onclick="return confirm('apa kamu yakin akan menghapus data?')"><i class="fas fa-trash"></i></button>
                                </form>
                            </div>
                        </td>
                    </tr>
